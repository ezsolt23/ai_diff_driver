...
class RosDriverNode(object):
    ...
    def __init__(self):
        ...
        self.setupListeners()
        self.pub_wheel_current_l = rospy.Publisher(
            "cmd_wheel_current_l", Float32, queue_size=10)
        self.pub_wheel_current_r = rospy.Publisher(
            "cmd_wheel_current_r", Float32, queue_size=10)
    ...
    def setupListeners(self):
        ...
        self.vel_subscriber = rospy.Subscriber(
            "/cmd_vel", Twist, self.vel_callback, queue_size=2)
        self.odom_subscriber = rospy.Subscriber(
            "/odometry/filtered", Odometry, self.odom_callback, queue_size=2)
